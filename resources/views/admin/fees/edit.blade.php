...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <a href="{{URL::route('edit-fee', $fee->id)}}">Edit Fee</a>
            </li>
        </ul>
        <!-- END PAGE BREADCRUMB -->
            ...
            <div class="col-md-12">
                ...
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body form">
                        ...
                        Form::open
                        ([
                            'route' =>  array('do-edit-fee', $fee->id),
                        ...
                        !!}
                            ...
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="name" class="form-control" value="{{$fee->name}}">
                                        @if($errors->has('name'))
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <select type="text" name="type" class="form-control">
                                            ...
                                            <option value="fixed" @if ($fee->type == 'fixed') selected="selected" @endif> Fixed </option>
                                            <option value="percent" @if ($fee->type == 'percent') selected="selected" @endif> Percent </option>
                                        </select>
