...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <a href="{{URL::route('add-category')}}">Add Category</a>
            </li>
        </ul>
        <!-- END PAGE BREADCRUMB -->
                    ...
                    <div class="portlet-body form">
                        ...
                        !!}
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Static Name</label>
                                    <div class="col-md-6">
                                        <input type="text" name="static_name" class="form-control">
                                        <span class="help-block"> The name will appear in URL</span>
                                        @if($errors->has('static_name'))
                                            <div class="alert alert-danger">
                                                <i class="fa fa-warning"></i>
                                                <strong>Error :</strong> {{$errors->first('static_name')}}
                                            </div>
                                        @endif
                                    </div>
                                </div>
