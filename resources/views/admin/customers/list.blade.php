...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <a href="{{URL::route('customers')}}">Customers List</a>
            </li>
        </ul>
        <!-- END PAGE BREADCRUMB -->
                ...
                <div class="portlet light portlet-fit bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-dark sbold uppercase">Customers List</span>
                        </div>
                    </div>
                        ...
                        <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>
                                        <a data-toggle="modal" href="#delete_product_{{$singleCustomer->id}}" class="btn btn-danger"> 
                                            <i class="fa fa-trash"></i>
                                        </a>
                                    </td>
                                </tr>
                                <div class="modal fade" id="delete_product_{{$singleCustomer->id}}" tabindex="-1" role="basic" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            {!! 
                                            Form::open
                                            ([
                                                'route' =>  array('do-delete-member', $singleCustomer->id),
